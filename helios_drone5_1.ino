...
if (synthMode) // If switch is set to high, run this portion of code
  ...
  envelope.setTimes(atkVal,susVal,relVal,dkyVal); // added sustain and release, previously fixed to 60000 (sixty sec)
  envelope.update();
