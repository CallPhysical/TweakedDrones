...
void updateControl(){
  ...
  aCos1.setFreq((mozziAnalogRead(A0))*8);
  aCos2.setFreq((mozziAnalogRead(A1))*8);
  aCos3.setFreq((mozziAnalogRead(A2))*8);
  aCos4.setFreq((mozziAnalogRead(A3))*8);
  aCos5.setFreq((mozziAnalogRead(A4))*8);
  aCos6.setFreq((mozziAnalogRead(A5))*8);
  aCos7.setFreq((mozziAnalogRead(A6))*8);
  aCos8.setFreq((mozziAnalogRead(A7))*8);
